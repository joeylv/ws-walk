...
func PreBooks(owner *walk.MainWindow) (int, error) {
	mw := &PreBookMainWindow{MainWindow: owner, model: PreBookModel()}
	var dlg *walk.Dialog
...
func (mw *PreBookMainWindow) tvItemactivated() {
	msg := ``
...
func (mw *PreBookMainWindow) openPreBook() {
